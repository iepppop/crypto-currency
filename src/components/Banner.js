    ...
    <group ref={group} {...props} dispose={null}>
      ...
      >
        <group position={[1.41, 0, 100]}>
          ...
          />
          <mesh
            geometry={nodes.Metalic_rim.geometry}
            material={materials["Metalic rim"]}
            rotation={[Math.PI / 2, 0, 0]}
            scale={[-1, 1, 1]}
          />
          <mesh
          ...
          />
          <mesh
            geometry={nodes.Flames.geometry}
      ...
      <Container>
        <Text>
          ...
          <Sub>
            ...
            <p>
              A secure system provides a fast and convenient trading experience.
            </p>
          </Sub>
          <h5>View all</h5>
        </Text>
